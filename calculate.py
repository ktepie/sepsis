...
from Random_forest import predict_class, predict_prob
# from evaluate_sepsis_score import load_sepsis_model, get_sepsis_score
...
if __name__ == '__main__':
    ...
    for i, f in enumerate(files):
        ...
        for t in range(num_rows):
            ...
            current_label = predict_class(current_data)
            current_score = predict_prob(current_data)
